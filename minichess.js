var B, i, y, u, b, I = [], G = 120, x = 10, z = 15, M = 1e4, l = [5, 3, 4, 6, 2, 4, 3, 5, 1, 1, 1, 1, 1, 1, 1, 1, 9, 9
    ...
    y ^= 8; G++; d = w || s && s >= h && X(0, 0, 0, 21, 0, 0) > M; do {
        if (o = I[p = O]) {
            q = o & z ^ y; if (q < 7) {
                A = q-- &
                    2 ? 8 : 4; C = o - 9 & z ? [53, 47, 61, 51, 47, 47][q] : 57; do {
                        r = I[p += l[C]]; if (!w | p == w) {
                            g = q | p + a - S ? 0
                                : S; if (!r & (!!q | A < 3 || !!g) || (r + 1 & z ^ y) > 9 && q | A > 2) {
                                    if (m = !(r - 2 & 7)) return y ^= 8, I[G--] =
                                        O, K; J = n = o & z; E = I[p - a] & z; t = q | E - 7 ? n : (n += 2, 6 ^ y); while (n <= t) {
                                            L = r ? l[r & 7 | 32] - h - q : 0; if (
                                                ...
                                                I[G] = O; if (s > 1) {
                                                    if (h && c - L
                                                        < 0) return y ^= 8, G--, L; if (!h) i = n, B = O, b = p;
                                                } N = L;
...
function W() {
    B = b; for (p = 21; p < 99; ++p)if (q = document.getElementById("o" + p)) {
        q.
...
function Y(s) {
    i = (I[s] ^ y) & z; if (i > 8) { b = s; W(); } else if (B && i < 9) {
        b = s; i = I[B] & z; if ((i &
